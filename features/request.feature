Feature: Request
  ...
  @automation
  Scenario: As a librarian, I can create own institution PUL to PUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter own institution PUL to PUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page

  @automation
  Scenario: As a librarian, I can create cross institution PUL to CUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution PUL to CUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page


  @automation
  Scenario: As a librarian, I can create cross institution PUL to NYPL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution PUL to NYPL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page

    #CUL
  @automation
  Scenario: As a librarian, I can create own institution CUL to CUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution CUL to CUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page


  @automation
  Scenario: As a librarian, I can create cross institution CUL to PUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution CUL to PUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page


  @automation
  Scenario: As a librarian, I can create cross institution CUL to NYPL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution CUL to NYPL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page

  #NYPL
  @automation
  Scenario: As a librarian, I can create own institution NYPL to NYPL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution NYPL to NYPL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page


  @automation
  Scenario: As a librarian, I can create cross institution NYPL to PUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution NYPL to PUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page


  @automation
  Scenario: As a librarian, I can create cross institution NYPL to CUL RETRIVAL request
    Given I launch the SCSB application
     When I login with valid credentials
      And I navigate to request page
      And I enter cross institution NYPL to CUL mandaory information for RETRIVAL request
      And I click create
     Then I should see request details in request page
